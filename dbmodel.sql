...
ALTER TABLE `player` ADD `score_area_1` TINYINT DEFAULT '0';
ALTER TABLE `player` ADD `score_area_2` TINYINT DEFAULT '0';
ALTER TABLE `player` ADD `score_area_3` TINYINT DEFAULT '0';
ALTER TABLE `player` ADD `score_area_4` TINYINT DEFAULT '0';
ALTER TABLE `player` ADD `score_area_5` TINYINT DEFAULT '0';
ALTER TABLE `player` ADD `score_area_6` TINYINT DEFAULT '0';
...
ALTER TABLE `player` ADD `bonus_1` TINYINT DEFAULT '-1';
ALTER TABLE `player` ADD `bonus_2` TINYINT DEFAULT '-1';
ALTER TABLE `player` ADD `bonus_3` TINYINT DEFAULT '-1';
ALTER TABLE `player` ADD `bonus_4` TINYINT DEFAULT '-1';
ALTER TABLE `player` ADD `bonus_5` TINYINT DEFAULT '-1';
ALTER TABLE `player` ADD `bonus_6` TINYINT DEFAULT '-1';
