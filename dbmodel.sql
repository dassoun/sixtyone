...
ALTER TABLE `player` ADD `area_3_1` INT UNSIGNED DEFAULT NULL;
ALTER TABLE `player` ADD `area_3_2` INT UNSIGNED DEFAULT NULL;
ALTER TABLE `player` ADD `area_3_3` INT UNSIGNED DEFAULT NULL;
ALTER TABLE `player` ADD `area_3_4` INT UNSIGNED DEFAULT NULL;
ALTER TABLE `player` ADD `area_3_5` INT UNSIGNED DEFAULT NULL;
